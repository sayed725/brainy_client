          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-2 lg:space-y-4 order-1 lg:order-2">
              ...
              <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 leading-relaxed">
                Earn money by sharing your expert knowledge with students. Sign
                up today and start tutoring online with Brainy — get paid
                securely and grow your teaching business.
              </p>
              ...
              <div className="pt-3 lg:pt-4">
                ...
                "
                >
                  <Link href={`/dashboard/upgrade-to-tutor`} className="flex items-center gap-2">
                    Become a Tutor
